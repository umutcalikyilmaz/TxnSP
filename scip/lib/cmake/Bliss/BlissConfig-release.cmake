...
set_target_properties(Bliss::libbliss PROPERTIES
  ...
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/libbliss.a"
  )

list(APPEND _IMPORT_CHECK_TARGETS Bliss::libbliss )
list(APPEND _IMPORT_CHECK_FILES_FOR_Bliss::libbliss "${_IMPORT_PREFIX}/lib/libbliss.a" )
...
set_target_properties(Bliss::bliss PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/bin/bliss"
  )

list(APPEND _IMPORT_CHECK_TARGETS Bliss::bliss )
list(APPEND _IMPORT_CHECK_FILES_FOR_Bliss::bliss "${_IMPORT_PREFIX}/bin/bliss" )
